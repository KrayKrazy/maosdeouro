    ...
    <div className="min-h-screen bg-[#050505] text-white font-roboto">
      <header className="bg-[#0a0a0a] border-b border-white/10 px-6 py-4 flex items-center justify-between sticky top-0 z-50">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-serif text-xl tracking-wider">Painel Administrativo</h1>
        </div>
        <nav className="flex gap-6 text-sm font-medium text-gray-400">
          <a href="/admin" className="text-[#D4AF37]">Produtos</a>
          <a href="/admin/config" className="hover:text-white transition-colors">Configura��es</a>
